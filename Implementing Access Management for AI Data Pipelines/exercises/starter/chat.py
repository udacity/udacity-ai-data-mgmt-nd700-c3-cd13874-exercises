...
# Change this to your Key Vault URI
KEY_VAULT_URI = "https://useraisecrets.vault.azure.net/"
...
def load_secrets() -> Dict[str, str]:
    ...
    try:
        embedding_deployment = client.get_secret(
            "azure-openai-embedding-deployment"
        ).value
    except Exception:
...
def main() -> None:
    ...
    print("Available roles:", ", ".join(policies.keys()))
